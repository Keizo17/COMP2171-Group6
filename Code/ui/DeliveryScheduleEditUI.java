    ...
    private class ContinueButtonListener implements ActionListener{
    	public void actionPerformed(ActionEvent e) {
    		...
    		try {
    			...
    			updateWin.dispose();
    			updater = new DeliveryScheduleEditUI(-1,schedlist,listing);
    		}
    		updateWin.dispose();
    		if (id != -1) {updater = new DeliveryScheduleEditUI(id,schedlist,listing);} //creates a new DeliveryScheduleEdit object to use for ID searching
    	}
    }
