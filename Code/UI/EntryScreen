...
public class EntryScreen extends JFrame{
    ...
    public EntryScreen(){
        ...
        JLabel title = new JLabel("T-CURLY", JLabel.SOUTH_EAST);
        ...
        lvl1button.setBackground(dpink);///set button bg colour
        ...
        lvl2button.setBackground(dpink);///set button bg colour
