...
public class CustomerValidater {
	...
	public ArrayList<Boolean> validate(customerRecord customer) {
		boolList.add(validateName(customer.getfName()));
		boolList.add(validateName(customer.getlName()));
		boolList.add(validateAge(customer.getAge()));
		boolList.add(validateAddress(customer.getAddress()));
		boolList.add(validatePhone(customer.getPhone()));
		boolList.add(validateEmail(customer.getEmail()));
		boolList.add(validateID(customer.getID()));
